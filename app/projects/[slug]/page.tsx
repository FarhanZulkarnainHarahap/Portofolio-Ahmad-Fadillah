    ...
    <>
      ...
      <section className="bg-[color:var(--primary)] px-4 py-14 text-white">
        <div className="mx-auto flex max-w-7xl flex-col justify-between gap-5 sm:flex-row sm:items-center">
          ...
          <Link className="inline-flex min-h-11 items-center justify-center rounded-full bg-white px-5 text-sm font-bold text-[color:var(--primary)]" href="/contact">Hubungi Saya</Link>
        </div>
      </section>
    </>
  );
