...
export async function HomePage() {
  const [profile, stats, experiences, expertise, projects, achievements, certifications, testimonials] = await Promise.all([
    ...
    apiList<Project>("/public/projects?featured=true&limit=4").catch(() => null),
  ...
  const proofGroups = [
    { title: "Pencapaian", href: "/achievements", items: achievements?.data ?? [] },
    { title: "Sertifikasi", href: "/certifications", items: certifications?.data ?? [] },
    { title: "Testimoni", href: "/testimonials", items: testimonials?.data ?? [] },
