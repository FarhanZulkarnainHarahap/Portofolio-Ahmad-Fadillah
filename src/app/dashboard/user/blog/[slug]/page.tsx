    ...
    <>
      ...
      {post.content ? (
        <Section eyebrow="Insight" title="Catatan profesional">
          ...
          <Link href="/dashboard/user/blog" className="mt-8 inline-flex items-center gap-2 rounded-full border border-[color:var(--border-strong)] px-4 py-2 text-sm font-bold"><FiArrowLeft /> Kembali</Link>
        </Section>
      ) : null}
    </>
  );
