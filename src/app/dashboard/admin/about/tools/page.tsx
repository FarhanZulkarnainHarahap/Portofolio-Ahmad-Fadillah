    ...
    <div>
      <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
        <div className="min-w-0">
          ...
          <h1 className="mt-3 overflow-wrap-anywhere font-heading text-3xl font-extrabold sm:text-4xl">Tools</h1>
        ...
        <Link className="inline-flex min-h-11 w-fit items-center gap-2 rounded-full bg-[color:var(--primary)] px-5 text-sm font-bold text-[color:var(--text-on-primary)]" href="/dashboard/admin/about/tools/create"><FiPlus />Tambah Tool</Link>
      </div>
      <div className="mt-6">
        {tools.length ? (
