  ...
  return (
    <section className="grid min-h-screen place-items-center px-4">
      <div className="premium-card max-w-md p-8 text-center">
        ...
        <Link className="mt-6 inline-flex rounded-full bg-[color:var(--primary)] px-5 py-3 text-sm font-bold text-[color:var(--text-on-primary)]" href="/auth/login">Masuk</Link>
      </div>
    </section>
  );
}
