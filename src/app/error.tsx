  ...
  return (
    <section className="grid min-h-screen place-items-center px-4">
      <div className="premium-card max-w-md p-8 text-center">
        ...
        <button className="mt-6 rounded-full bg-[color:var(--primary)] px-5 py-3 text-sm font-bold text-[color:var(--text-on-primary)]" onClick={reset} type="button">Coba lagi</button>
      </div>
    </section>
  );
}
